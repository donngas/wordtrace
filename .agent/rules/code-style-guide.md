...
- When adding a new file, always analyze and understand the existing file structure, both through the DOCS and the file system, and choose appropriate place, rather than arbitrarily placing one.
